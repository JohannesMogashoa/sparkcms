        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    spaark_id = table.Column<int>(type: "INTEGER", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_spark_contents", x => x.id);
                    table.ForeignKey(
                        name: "fk_spark_contents_sparks_spaark_id",
                        column: x => x.spaark_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_spark_contents_spaark_id",
                table: "spark_contents",
                column: "spaark_id");

            migrationBuilder.CreateIndex(
                name: "ix_sparks_user_id",
                table: "sparks",
                column: "user_id");
